const Map = () => {
    return (
        <div className="w-full text-black py-16" id="peta-persebaran-section">
            <h1 className="text-5xl font-semibold">
                <a aria-label="Link to Sectionz">Peta Persebaran</a>
            </h1>
            <p className="text-base mb-6">Visualisasi geografis atas laporan kerusakan jalan yang dihimpun melalui partisipasi publik.</p>
            <div className="flex bg-blue-800 rounded-4xl w-full h-[512px] p-4 justify-end items-start">
