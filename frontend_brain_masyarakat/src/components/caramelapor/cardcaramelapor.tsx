    ...
    return (
        <div className="w-full h-[6rem] md:h-[7rem] lg:h-[7.5rem] border-[#BFBFBF] border-2 rounded-3xl">
            <div className="w-full h-full flex flex-row  place-items-center p-4">
                <IconCara icon={
                    <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" fill="#0063F4" viewBox="0 0 256 256">
                ...
                <div className="pl-4 text-black">
                    <div className="font-medium text-sm">Isi Form.</div>
                    <div className="font-normal text-xs">Masukkan judul, jenis, dan deskripsi pengaduan</div>
                </div>
            </div>
        </div>
    )
