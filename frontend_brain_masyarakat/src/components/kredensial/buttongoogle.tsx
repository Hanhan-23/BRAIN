...
const ButtonGoogle = () => {
    return(
        <Button variant={"outline"} className="w-full h-14 place-items-center place-content-center p-2 gap-2 bg-white hover:bg-gray-50 cursor-pointer rounded-full border border-[#CAD5E2]">
